    ...
    <div class="soundcloud-page__container w-full max-w-sm space-y-8">
      ...
      <div class="soundcloud-page__actions space-y-2">
        ...
        >
          ...
          <p v-if="joinError" class="soundcloud-page__error text-xs text-destructive">
            {{ joinError }}
          </p>
          <p v-else-if="createError" class="soundcloud-page__error text-xs text-destructive">
            {{ createError }}
          </p>

          <Button
            class="soundcloud-page__join-submit h-9 w-full"
            variant="secondary"
